...
///
Widget internalMenuItems(
    {required mq, required cmh, required cmw, required context}) {
  ...
  return PopupMenuButton<String>(
      ...
      itemBuilder: (BuildContext context) {
        List icons = [
          const Icon(Icons.star, color: Color(0xff333333)),
...
Widget customTextButton({required onPressed,
