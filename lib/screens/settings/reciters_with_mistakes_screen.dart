...
class RecitersWithMistakes extends StatefulWidget {
  const RecitersWithMistakes({Key? key}) : super(key: key);

  @override
  _RecitersWithMistakesState createState() => _RecitersWithMistakesState();
}

class _RecitersWithMistakesState extends State<RecitersWithMistakes> {
  List reciters = Reciters().recitersWithMistakes;
                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'These Reciters have mistakes in mentioned verses.',
                                style: TextStyle(
                                    fontSize: cmh * 0.017,
                        ...
                        return TextButton(
                          ...
                          onPressed: () {
                            audioProvider.assignRecitationStyle(
                                style: reciters[index]['recitation_style_1']
                                    .toString());
                            ...
                            audioProvider.assignReciterName(
                                selectedReciterShortName: reciters[index]
                                    ['short_name'],
      ...
      child: PrimaryScrollController(
        ...
        child: Scrollbar(
          ...
          child: ListView.builder(
            ...
            physics: reciters[index]['reciter_name'] != 'Minshawy'
                ? const NeverScrollableScrollPhysics()
                : null,
            itemCount: reciters[index]['mistakes'].length,
            itemBuilder: (context, index2) => Column(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                ///
                if (reciters[index]['reciter_name'] == 'Minshawy' &&
                    index2 == 0)
                  Text.rich(
                    TextSpan(children: [
                      TextSpan(
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        reciters[index]['mistakes'][index2]['surah_number']
                            .toString(),
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Colors.blueGrey,
                    ...
                    Expanded(
                      child: Text(
                        reciters[index]['mistakes'][index2]['verse_number']
                            .toString(),
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Colors.blueGrey,
